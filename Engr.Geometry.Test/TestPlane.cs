...
namespace Engr.Geometry.Test
{
    ...
    public class TestPlane
    {
        ...
        {
            var p1 = new Plane(new Vect3(1, 2, 3), 0);
            ...
            var p2 = new Plane(new Vect3(4, 5, 6), 5);
            ...
            var p3 = Plane.FromPoints(new Vect3(1,-2,0), new Vect3(3,1,4), new Vect3(0,-1,2));
        ...
        {
            var a = new Plane(new Vect3(2, 0, 0), -2).Normalize();
            Assert.AreEqual(a.DistanceTo(new Vect3(4, 0, 0)), 3, Constants.Delta);
            Assert.AreEqual(a.DistanceTo(new Vect3(1, 0, 0)), 0, Constants.Delta);
        }

        [TestMethod]
        public void Invert()
        {
            var a = new Plane(new Vect3(1, 0, 0), -1).Invert();
            Assert.AreEqual(a.DistanceTo(new Vect3(4, 0, 0)), -3, Constants.Delta);
            Assert.AreEqual(a.DistanceTo(new Vect3(1, 0, 0)), 0, Constants.Delta);
        }
    }
